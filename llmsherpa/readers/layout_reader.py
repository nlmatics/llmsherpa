class Block:
    ...
    def to_markdown(self, include_children=False, recurse=False):
        """
        Converts the block to markdown. This is a virtual method and should be implemented by the derived classes.
        """
        pass
...
class Paragraph(Block):
    ...
    def to_markdown(self, include_children=False, recurse=False):
        """
        Converts the paragraph to markdown. If include_children is True, then the markdown of the children is also included. If recurse is True, then the markdown of the children's children are also included.

        Parameters
        ----------
        include_children: bool
            If True, then the markdown of the children are also included
        recurse: bool
...
class Section(Block):
    ...
    def to_markdown(self, include_children=False, recurse=False):
        """
        Converts the section to markdown. If include_children is True, then the markdown of the children is also included. If recurse is True, then the markdown of the children's children are also included.
...
class ListItem(Block):
    ...
    def to_markdown(self, include_children=False, recurse=False):
        """
        Converts the list item to markdown. If include_children is True, then the markdown of the children is also included. If recurse is True, then the markdown of the children's children are also included.
...
class TableCell(Block):
    ...
    def to_html(self):
        """
        Returns the cell value as html. If the cell value is a paragraph node, then the html of the node is returned.
        """
    ...
    def to_markdown(self):
        """
        Returns the cell value as Markdown. If the cell value is a paragraph node, then the Markdown of the node is returned.
        """
        cell_markdown = self.cell_value
        if self.cell_node:
            cell_markdown = self.cell_node.to_markdown()
...
class TableRow(Block):
    ...
    def to_markdown(self, include_children=False, recurse=False):
        """
        Returns Markdown for a table row with Markdown from all the cells in the row delimited by '|'
        """
        markdown_str = "| "
        for cell in self.cells:
            markdown_str += cell.to_markdown() + " | "
...
class TableHeader(Block):
    ...
    def to_markdown(self, include_children=False, recurse=False):
        """
        Returns Markdown for a table header row with Markdown from all the cells in the row delimited by '|'
        and a separator row with '---' for each cell.
        """
        markdown_str = "| "
        for cell in self.cells:
            markdown_str += cell.to_markdown() + " | "
...
class Table(Block):
    ...
    def to_markdown(self, include_children=False, recurse=False):
        """
        Returns markdown for a table from all the rows in the table
        """
        markdown_str = ""
        for header in self.headers:
            markdown_str += header.to_markdown() + "\n"
        for row in self.rows:
